  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:mb-2">
        <Link
          href="/"
          className={`${ranga.className} text-xl lg:text-3xl underline underline-offset-1 decoration-4 text-purple-800`}
        >
          Return home
        </Link>
      </div>
      <div
        className={
          ...
          "rounded-xl p-1 pb-10 pt-10 m-2 lg:p-10"
        }
      >
        {children}
      </div>
